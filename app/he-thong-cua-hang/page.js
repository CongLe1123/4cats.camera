...
export const metadata = {
  title: "Hệ Thống Cửa Hàng & Bản Đồ Chỉ Đường — 4cats Camera",
  description:
    "Ghé thăm các cơ sở của 4cats Camera tại Cầu Giấy và Thanh Xuân (Hà Nội) để trải nghiệm máy ảnh trực tiếp và nhận tư vấn chu đáo nhất.",
  alternates: {
    canonical: "https://4catscamera.com/he-thong-cua-hang",
  },
  openGraph: {
    title: "Hệ Thống Cửa Hàng & Bản Đồ Chỉ Đường — 4cats Camera",
    description:
      "Ghé thăm các cơ sở của 4cats Camera tại Cầu Giấy và Thanh Xuân (Hà Nội) để trải nghiệm máy ảnh trực tiếp.",
    url: "https://4catscamera.com/he-thong-cua-hang",
    type: "website",
  },
};
        ...
        {settings.locations?.map((loc, index) => (
          ...
          >
            <div className="h-64 bg-gray-100 relative overflow-hidden shrink-0">
              {loc.iframe_url ? (
                <iframe
                  title={`Bản đồ chỉ đường ${loc.name || `Chi nhánh ${index + 1}`}`}
                  src={loc.iframe_url}
                  width="100%"
                  height="100%"
                  style={{ border: 0 }}
                ...
                <iframe
                  title="Bản đồ chỉ đường Cơ sở 1 - Cầu Giấy (Số 6A2 ngõ 158 Nguyễn Khánh Toàn)"
                ...
                <iframe
                  title="Bản đồ chỉ đường Cơ sở 2 - Thanh Xuân (Số 51 Nguyễn Trãi)"
