    ...
    <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
      {brands.map((brand, i) => {
        ...
        return (
            ...
            className={`relative overflow-hidden rounded-2xl h-32 bg-gradient-to-br ${style.gradient} group transition-all duration-300 hover:shadow-lg hover:scale-[1.05] flex items-center justify-center p-4 border border-white/50 text-center`}
            >
            {/* Text Content */}
            <div className="z-10 flex flex-col items-center gap-1">
                <h3
                className={`text-xl font-black uppercase tracking-tighter drop-shadow-sm ${style.text}`}
