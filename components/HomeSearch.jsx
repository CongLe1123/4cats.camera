  ...
  return (
    <div className="w-full max-w-3xl mx-auto px-4 sm:px-6 relative z-20">
      <form onSubmit={handleSearch} className="relative group">
        ...
        <button
          type="submit"
          className="absolute right-2 top-2 bottom-2 bg-primary text-white px-5 md:px-8 rounded-full font-bold text-xs md:text-base hover:brightness-110 transition-all hover:scale-[1.02] active:scale-[0.98] shadow-lg shadow-primary/25 cursor-pointer"
        >
          Tìm Kiếm
        </button>
      </form>
